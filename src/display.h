...
#define DISP_F    NEG(_SEGA | _SEGE | _SEGF | _SEGG)
#define DISP_T    NEG(_SEGE | _SEGF | _SEGG)
#define DISP_A    NEG(_SEGA | _SEGB | _SEGC | _SEGE | _SEGF | _SEGG)
#define DISP_N    NEG(_SEGB | _SEGE | _SEGG)
